                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <router-link :to="{ name: 'member.deactivation' }">
                                    <button class="btn btn-md btn-success">
                                        <i class="bi bi-eye"> Member Expired</i>
                                    </button>
                                </router-link>
                            </div>
                            <div class="col-4">
                                ...
                                <tr v-for="(member, id_member) in member" :key="id_member">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col-4">
                                                <button @click.prevent="deactivation(member.id_member)" class="btn btn-sm btn-info">
...
export default {
    setup() {
        ...
        function deactivation($id_member) {
            axios
                .post("http://localhost:8000/api/member_deak/" +$id_member, {
