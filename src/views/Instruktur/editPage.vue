...
export default {
    setup() {
        ...
        onMounted(() => {
            ...
            axios.get(`https://arvell.valent.ppcdeveloper.com/api/instruktur/${route.params.id_instruktur}`,)
            .then(response => {
        ...
        function update() {
            ...
            axios
            .put(`https://arvell.valent.ppcdeveloper.com/api/instruktur/${route.params.id_instruktur}`, {
                nama: nama,
                email: email,
                password: password,
                gender: gender,
