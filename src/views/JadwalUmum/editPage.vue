...
export default {
    setup() {
        ...
        onMounted(() => {
            ...
            axios.get(`http://arvell.valent.ppcdeveloper.com/api/jadwal_umum/${route.params.id_jadwal_umum}`,)
            .then(response => {
        ...
        function update() {
            ...
            axios
            .put(`http://arvell.valent.ppcdeveloper.com/api/jadwal_umum/${route.params.id_jadwal_umum}`, {
